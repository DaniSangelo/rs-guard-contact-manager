    ...
    <div class="m-10 flex">
        ...
        <div class="flex flex-col h-screen p-4 items-center justify-between w-50">
            ...
            <div class="flex flex-col space-y-2">
                ...
                <!-- logout icon -->
                <a class="rounded-lg p-2 bg-background-tertiary cursor-pointer" href="/logout">
                    <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center gap-4">
                                                    <a id="edit" href="#" class="outline p-3 rounded-md hover:bg-background-tertiary flex items-center gap-2">
                                                    ...
                                                    <a id="lock-open" href="#" class="rounded-lg p-2 outline items-center justify-center hover:fill-accent-brand fill-content-primary">
                                                        <svg
                                                            width="15"
                                                            height="15"
                                                            viewBox="0 0 24 24">
                                                    ...
                                                    <a id="trash" href="#" class="rounded-lg p-2 outline items-center justify-center hover:fill-accent-red fill-content-primary">
                                                        <svg
                                                            width="15"
                                                            height="15"
                                                            viewBox="0 0 24 24">
...
<!-- Modal -->
<div id="password-modal" class="fixed inset-0 flex items-center justify-center bg-black/50 hidden z-50">
    <div class="bg-background-secondary rounded-xl p-6 w-[400px] shadow-lg relative">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-content-primary">Visualizar informações</h2>
            <button id="close-modal" class="text-content-muted hover:text-content-primary">
...
<script>
    ...
    const submitBtnModal = document.getElementById('submit-btn-modal');
    const cancelBtn = document.getElementById('cancel-modal');
    const openBtns = document.querySelectorAll('[id="lock-open"]');

    function openModal(e) {
        e.preventDefault();
        modal.classList.remove('hidden');
        dashboardContent.classList.add('blur-sm');
    }

    function closeModal() {
        modal.classList.add('hidden');
        inputModalPassword.value = '';
        dashboardContent.classList.remove('blur-sm');
    }
